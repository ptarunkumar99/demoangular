...
var CartsComponent = /** @class */ (function () {
    function CartsComponent(sharedService) {
...
var ForgotPwdComponent = /** @class */ (function () {
    function ForgotPwdComponent(fgtService, _route) {
        this.fgtService = fgtService;
        this._route = _route;
    }
    ForgotPwdComponent.prototype.ngOnInit = function () { };
    // Checking User exists in database or not
    ForgotPwdComponent.prototype.isUsersExists = function () {
        var _this = this;
        if (this.userlist != null && this.userlist.length > 0) {
            var lstuser = this.userlist.filter(function (a) { return a.mailid == _this.mailID; });
    ...
    ForgotPwdComponent.prototype.onSubmit = function (value) {
        var _this = this;
...
var ForgotPwdService = /** @class */ (function () {
    ...
    // }
    ForgotPwdService.prototype.searchUser = function (mailID) {
...
var InMemoryDataService = /** @class */ (function () {
    ...
    InMemoryDataService.prototype.createDb = function () {
        ...
        return { users: users, products: products, orders: orders, cartItems: cartItems };
    }; //Db close
...
var ItemDetailsComponent = /** @class */ (function () {
    function ItemDetailsComponent(_route, route, sharedService) {
        this._route = _route;
        this.route = route;
        this.sharedService = sharedService;
        this.user = '';
    ...
    ItemDetailsComponent.prototype.getSelectedItem = function (id) {
        this.items = this.list.filter(function (a) { return a.id == id; })[0];
    };
    ItemDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.sharedService.getProducts()
            .subscribe(function (items) {
            _this.list = items;
            _this.getSelectedItem(id);
        });
    };
    ItemDetailsComponent.prototype.navigateToCartsPage = function () {
        this._route.navigate(["../../Carts"], { relativeTo: this.route });
    };
    ItemDetailsComponent.prototype.navigateToCheckoutPage = function () {
    ...
    ItemDetailsComponent.prototype.addtocart = function () {
        ...
        this.sharedService.addToCart(this.items).subscribe(function (v) {
            _this.navigateToCartsPage();
        });
    };
    ItemDetailsComponent.prototype.BuyNow = function (items) {
        // Get Existing Orders
        var _this = this;
        ...
        this.sharedService.createOrders(this.items).subscribe(function (v) {
            _this.navigateToCheckoutPage();
        });
    };
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(_route, loginService) {
        this._route = _route;
    ...
    // Checking User exists in database or not
    LoginComponent.prototype.isUsersExists = function () {
        var _this = this;
        var lstuser = this.userlist.filter(function (a) { return a.mailid == _this.username; });
    ...
    LoginComponent.prototype.isUserExists = function () {
        var _this = this;
        var lstuser = this.userlist.filter(function (a) { return a.mailid == _this.username; });
        if (lstuser.length > 0) {
...
var OrderComponent = /** @class */ (function () {
    function OrderComponent(sharedService) {
        this.sharedService = sharedService;
    }
...
var ProductsComponent = /** @class */ (function () {
    function ProductsComponent(productService, _route, activatedRoute) {
    ...
    ProductsComponent.prototype.ngOnInit = function () {
        ...
        this.productService.getProducts()
            ...
            _this.filteredItems = products;
        });
    };
    ProductsComponent.prototype.FilterByName = function () {
        var _this = this;
        this.filteredItems = [];
        if (this.inputName != "") {
    ...
    ProductsComponent.prototype.onItemClick = function (item) {
...
var RegistrationComponent = /** @class */ (function () {
    function RegistrationComponent(_route, regService) {
        this._route = _route;
    ...
    RegistrationComponent.prototype.navigateToLogin = function (value) {
        alert("User " + value.fname + " Created Successfully!!!");
        this._route.navigate(["Login"]);
    };
    RegistrationComponent.prototype.onSubmit = function (value) {
        var _this = this;
        console.log(value);
        this.regService.createeUser(value).subscribe(function (v) { return _this.navigateToLogin(value); });
    };
...
var RegistrationService = /** @class */ (function () {
    ...
    RegistrationService.prototype.createeUser = function (user) {
...
var SharedService = /** @class */ (function () {
    ...
    SharedService.prototype.getProducts = function () {
        return this.http.get(this.productUrl);
    };
    SharedService.prototype.addToCart = function (item) {
        return this.http.post(this.cartUrl, item, httpOptions);
    };
    SharedService.prototype.getOrders = function () {
        return this.http.get(this.ordersUrl);
    };
    SharedService.prototype.createOrders = function (order) {
        return this.http.post(this.ordersUrl, order, httpOptions);
    };
    SharedService.prototype.getCarts = function () {
